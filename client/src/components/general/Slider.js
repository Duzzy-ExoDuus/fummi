...
import {Badge, Button, UncontrolledCollapse,Collapse} from 'reactstrap'
...
class Slider extends Component {
    ...
    render() {
        ...
        return (
            <>
                <div style={nameStyle}>
                    <SliderButton onClick={()=>this.props.handleAttributeClick(this.props.index)}>
                ...
                <Collapse isOpen={this.props.openedIndex === this.props.index}>
