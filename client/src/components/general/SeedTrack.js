            ...
            <>
                <ListItem>
                    <CoverImageDiv>
                        <PreviewDiv>
                            {
                                ...
                                <PreviewSVG fill={preview_url ? "black" : "none"}
                                    onClick={() => this.setState({playingPreview: !this.state.playingPreview})} xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                        ...
                        <CoverImage src={album.images[0] == null ? defaultAlbumImage : album.images[0].url} width="10%"
                                    height="auto" alt=""/>
                    </CoverImageDiv>
